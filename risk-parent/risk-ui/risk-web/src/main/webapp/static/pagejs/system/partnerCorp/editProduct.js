...
$(function(){
	...
	$(".tab-pane").each(function(){
		...
		parentPane.find('input[name="feeConfig.repaymentType"]').bind('click',function(){
			var flag = false;
			parentPane.find('.repaymentType:checked').each(function(){
				if($(this).val()==3){
					flag = true;
				}
			});
			if((flag && $(this).is(':checked') && $(this).val()==3) || (flag && parentPane.find('.repaymentType:checked').length==1)){
				parentPane.find("#nomal-repayment").hide();
				parentPane.find("#lump-sum-repayment").show();
			}else{
				parentPane.find("#nomal-repayment").show();
				parentPane.find("#lump-sum-repayment").hide();
			}
			...
			if($(this).val()==3 && (!$(this).is(':checked'))){
				parentPane.find('input[name="feeConfig.lumpSumTerm"]').prop("checked",false);
		...
		parentPane.find("#znjl_fee_add").bind('click',function(){
			...
			parentPane.find("#znjlFeeForm #znjlStart").val('');
			parentPane.find("#znjlFeeForm #znjlEnd").val('');
			parentPane.find("#znjlFeeForm #znjlFee").val('');
			targetPane = $(this).parents(".tab-pane");
		});
		...
		parentPane.find("#bzjl_fee_add").bind('click',function(){
			...
			parentPane.find("#bzjlFeeForm #bzjlStart").val('');
			parentPane.find("#bzjlFeeForm #bzjlEnd").val('');
			parentPane.find("#bzjlFeeForm #bzjlFee").val('');
			targetPane = $(this).parents(".tab-pane");
		});
		...
		parentPane.find("#other_fee_add").bind('click',function(){
			...
			parentPane.find("#otherFeeForm #otherStart").val('');
			parentPane.find("#otherFeeForm #otherEnd").val('');
			parentPane.find("#otherFeeForm #otherFee").val('');
			targetPane = $(this).parents(".tab-pane");
		});
		...
		parentPane.find("#savFeeConfigBtn").bind('click',function(){
			var obj = packageValue($(this).parents(".tab-pane"));
