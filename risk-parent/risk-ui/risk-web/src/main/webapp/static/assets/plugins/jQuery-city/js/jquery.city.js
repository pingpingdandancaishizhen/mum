                        ...
                        $('.city-item-center > a').on('click', function (event) {
                            ...
                            if (dataInfo != undefined) {
                                ...
                                if (dataInfo.provinceName != undefined && dataInfo.cityName != undefined && dataInfo.areaName != undefined) {
                                    ...
                                    var addressInfo = $.trim(dataInfo.provinceName) + p.separator + $.trim(dataInfo.cityName) + p.separator + $.trim(dataInfo.areaName);
                                    if (p.onChoice) {
                                        p.onChoice(dataInfo);
                                    }
                    ...
                    $(".city-search-item li").on('click', function (event) {
                        ...
                        if (dataJson != undefined) {
                            ...
                            if ($(this).attr('nextobj') == 'area') {
                                ...
                                var addressInfo = $.trim(dataJson.provinceName) + p.separator + $.trim($dataJson.cityName) + p.separator + $.trim(dataJson.areaName);
