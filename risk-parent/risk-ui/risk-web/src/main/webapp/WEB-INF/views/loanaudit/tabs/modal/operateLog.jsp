								...
								<form onsubmit="return false;"  class="form-inline form-label-auto" role="form">
									...
									<div class="form-group col-sm-5 row-left">
										<div class="input-group">
											<label class="label-head">操作人</label>
									...
									<div class="form-group col-sm-5 row-left">
										<div class="input-group">
											<label class="label-head">操作时间</label>
...
<script type="text/javascript" src="${ctx}/static/pagejs/loanaudit/loan-log.js${timeStyle}"></script>