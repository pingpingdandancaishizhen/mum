...
<%@ include file="/WEB-INF/import/loading.jsp"%>
  ...
  <div class="content-wrapper">
    ...
    <section class="content content-padding">
		...
		<div id="toolbar">
			<div class="btn-group">
				<shiro:hasPermission name="myloan:log">
					<div class="btn btn-white" id="myLoan_log_btn">
						<span>日志</span>
					</div>
				</shiro:hasPermission>
				<shiro:hasPermission name="myloan:view">
					<div class="btn btn-white" id="myLoan_view_btn">
						<span>查看</span>
					</div>
				</shiro:hasPermission>
				<shiro:hasPermission name="myloan:restart">
					<div class="btn btn-white" id="myLoan_restart_btn">
						<span>启用</span>
					</div>
				</shiro:hasPermission>
			</div>
		...
		<table class="table  table-striped table-hover" id="myLoan_table" data-toggle="table" style="width: 2500px"
			   data-url="${ctx}/loanApply/myLoan/queryMyLoanList"
			...
			<tr>
				...
				<th data-field="bpNo" data-width="250">订单号</th>
				<th data-field="custName" <shiro:hasPermission name='loan:custdetail'>data-formatter="custNameFormatter"</shiro:hasPermission>
				>客户名称</th>
				...
				<th data-field="deptName" data-width="250">所属门店</th>
...
<shiro:hasPermission name="myloan:restart">
<script type="text/javascript" src="${ctx}/static/pagejs/loanApply/myLoan/myLoan-restart.js"></script>
</shiro:hasPermission>
</html>