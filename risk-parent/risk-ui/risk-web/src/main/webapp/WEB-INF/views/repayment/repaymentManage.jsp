...
<%@ include file="/WEB-INF/import/loading.jsp"%>
  ...
  <div class="content-wrapper">
    ...
    <section class="content content-padding">
					...
					<div class="input-group">
						...
						<select  class="form-control" name="status">
							...
							<c:forEach items="${status}" var="statu">
								<option value="${statu.status}">${statu.statusName}</option>
							</c:forEach>
						</select>
					</div>
		...
		<div id="toolbar">
			<div class="btn-group">
				<shiro:hasPermission name="loanhk:plan">
					<div class="btn btn-white" id="repayment_plan_btn">
						<span>还款计划</span>
					</div>
				</shiro:hasPermission>
				<shiro:hasPermission name="loanhk:record">
					<div class="btn btn-white" id="repayment_record_btn">
						<span>正常还款录入</span>
					</div>
				</shiro:hasPermission>
				...
				<shiro:hasPermission name="loanhk:early">
					<div class="btn btn-white" id="early_record_btn">
						<span>提前结清录入</span>
					</div>
				</shiro:hasPermission>
				<shiro:hasPermission name="loanhk:export">
		...
		<table class="table  table-striped table-hover" id="repayment_table" data-toggle="table" style="width: 1800px"
			   data-url="${ctx}/repayment/queryRepaymentList"
			...
			<tr>
				...
				<th data-field="loanContractId">借款合同号</th>
				...
				<th data-field="payedInterest">已还利息</th>
				<th data-field="payedPrinciple">已还本金</th>
				<th data-field="payedPrinciple" data-formatter="unRepaymentFormatter">未还本金</th>
				<th data-field="issueDay">还款日</th>
				<th data-field="overdueDay">逾期天数</th>
				<th data-field="status">还款状态</th>
			</tr>
			</thead>
		</table>
    </section>
  ...
  <!-- /.content-wrapper -->
	...
	<script type="text/javascript" src="${ctx}/static/pagejs/repayment/repayment.js"></script>
