...
<%@ include file="/WEB-INF/import/loading.jsp"%>
  ...
  <div class="content-wrapper">
    ...
    <section class="content content-padding">
					<div  class="search-box" id="searchbar"	>
						...
						<div  class="form-group col-md-3 row-left"	>
							<div class="input-group">
							   <label class="label-head text-right" >企业名称：</label>
					...
					<div  class="form-group col-md-3 row-left"	>
					 <div class="input-group">
                           <label class="label-head text-right" >资产方归属：</label>
		      	...
		      	<div id="toolbar">
           		...
           		<table class="table table-bordered table-hover" id="p2pAsset_table" data-toggle="table"
				...
				data-pagination="true" data-page-list="[10, 15, 20]"  data-toolbar="#toolbar">
					<thead>
						<tr>
							...
							<th data-field="assetProduct">产品</th>
