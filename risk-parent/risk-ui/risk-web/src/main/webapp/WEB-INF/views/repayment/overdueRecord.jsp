...
<%@ include file="/WEB-INF/import/loading.jsp"%>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
		<!--<div class="body-header">
			...
			<div class="body-title">逾期还款录入</div>
		</div>-->
							...
							<c:forEach items="${requestDetails}" var="detail" varStatus="status">
								<tr>
									...
									<td>
										${detail.overdueDay}
										<c:if test="${detail.overdue}">
											<input type="hidden" id="overdueCount" name="overdueCount" value="${detail.overdueDay}">
									...
									<td class="table-no-padding">
										<div class="inner-form">
											...
											<c:forEach items="${detail.records}" var="record">
												<span>
													<fmt:formatDate value="${record.repaymentTime}" pattern="yyyy-MM-dd"/><br/>
												</span>
											</c:forEach>
											<c:if test="${detail.overdue}">
												<span>
														...
														<div class="form-group no-margin clearfix ">
															<input type="text" class="form-control" id="repaymentTime" name="repaymentTime" readonly="readonly" value="<fmt:formatDate value="${defaultDate}" pattern="yyyy-MM-dd"/>">
														</div>
										...
										<div class="inner-form">
											...
											<c:forEach items="${detail.records}" var="record">
												<span>
														...
														<fmt:formatNumber value="${empty record.overdueFee? 0 : record.overdueFee }" pattern="#,##0.00#"/>
											...
											<c:if test="${detail.overdue}">
												<span>
														...
														<div class="form-group no-margin clearfix">
															<input type="text" class="form-control" id="overdueFee" name="overdueFee" value="${detail.overdueFee}">
															<input type="hidden" value="${detail.overdueFee}" id="maxOverdueFee">
														</div>
										...
										<div class="inner-form">
											...
											<c:forEach items="${detail.records}" var="record">
												<span>
														...
														<fmt:formatNumber value="${empty record.overdueDerate? 0 : record.overdueDerate}" pattern="#,##0.00#"/>
											...
											<c:if test="${detail.overdue}">
												<span>
														...
														<div class="form-group no-margin clearfix">
															<input type="text" id="overdueDerate" class="form-control" name="overdueDerate" value="0">
														</div>
  ...
  <!-- /.content-wrapper -->
 <script type="text/javascript" src="${ctx}/static/pagejs/repayment/overdueRecord.js"></script>
</body>
</html>