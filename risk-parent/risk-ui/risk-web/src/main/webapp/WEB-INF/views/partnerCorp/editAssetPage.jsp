                        ...
                        <div class="col-sm-6 row-right">
                          ...
                          <div class="col-sm-6 row-right ">
                            <div class="form-group input-group">
                                ...
                                <div class="label-box label-box-sm">
                                    <input type="text" maxlength="20" value="${asset.acceptAccountNum}" class="form-control" id="acceptAccountNum" name="acceptAccountNum">
                                </div>
                                    ...
                                    <select class="form-control" name="acceptAccountBank"
                                        ...
                                        <option value="">请选择</option>
                                         <c:forEach items="${banks}" var="bank">
                                                        ...
                                                        <c:if test="${asset.acceptAccountBank== bank.id}">
                                                            selected="selected"
                                                        </c:if>
                                                        >
                                                            ${bank.bankName}
