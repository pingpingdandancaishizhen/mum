...
<div class="modal" id="modifyRoleModal" tabindex="-1" role="dialog" aria-expanded="true">
	...
	<div class="modal-content">
		<div class="modal-header">
					...
					<h4 class="modal-title">编辑数据角色</h4>
		</div>
		<div class="modal-body">
			<div class="panel-body">
				<form onsubmit="return false;"  class="form-horizontal form-label-auto" id="modifyRoleForm" action="${ctx}/system/dataRole/modifyDataRole" method="post">
				 <div class="box-body">
					 <div class="col-sm-12">
...
<script type="text/javascript" src="${ctx}/static/pagejs/system/dataRole/dataRole-modify.js${timeStyle}"></script>