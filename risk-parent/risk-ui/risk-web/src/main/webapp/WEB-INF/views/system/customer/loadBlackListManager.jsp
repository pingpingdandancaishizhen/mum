...
<%@ include file="/WEB-INF/import/loading.jsp"%>
  ...
  <div class="content-wrapper">
    ...
    <section class="content content-padding">
		...
		<div id="toolbar">
			<div class="btn-group">
				<shiro:hasPermission name="blacklist:remove">
					<div class="btn btn-white" id="remove_blacklist_btn">

						<span>移除黑名单</span>
					</div>
				</shiro:hasPermission>
				<shiro:hasPermission name="blacklist:log">
					<div class="btn btn-white" id="customer_log_btn">
						<span>日志</span>
					</div>
				</shiro:hasPermission>
				<shiro:hasPermission name="blacklist:detail">
		...
		<table class="table  table-striped table-hover" id="customer_table" data-toggle="table"
			   data-url="${ctx}/system/customer/queryBlackList"
 ...
 <script type="text/javascript" src="${ctx}/static/pagejs/system/blackList/blacklist.js"></script>
