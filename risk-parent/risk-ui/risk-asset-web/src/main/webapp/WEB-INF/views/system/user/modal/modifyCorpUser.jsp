...
<div class="modal" id="modifyCorpUserModal" tabindex="-1" role="dialog" aria-expanded="true">
	...
	<div class="modal-content" style="width: 600px;">
		...
		<div class="modal-body">
			<div class="panel-body">
				<form onsubmit="return false;"  class="form-inline form-label-auto " id="modifyCorpUserForm" action="${ctx}/system/user/modifyUser" method="post" style="overflow: hidden;">
					<div class="box-body">
						<div class="col-md-8 ">
						...
						<div class=" col-md-12 ">
							<div class="input-group form-group">
								<label  class="label-head text-right label-head-top">流程权限：</label>
								<div class="label-box label-box-top "  id="metaNodes" >
								</div>
							</div>
						</div>
		...
		<div class="modal-footer">
			<div  class="btn btn-primary" id="modifyCorpUserBtn" data-loading-text="确定中...">确定</div>
			<div  class="btn btn-cancel" data-dismiss="modal">取消</div>
		</div>
	</div>
	</div>
</div>
<script type="text/javascript" src="${ctx}/static/pagejs/system/user/user-modify.js"></script>