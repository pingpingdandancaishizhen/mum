...
<div class="modal" id="addRoleModal" tabindex="-1" role="dialog" aria-expanded="true">
	...
	<div class="modal-content">
		<div class="modal-header">
					...
					<h4 class="modal-title">新增功能角色</h4>
		</div>
		<div class="modal-body">
			<div class="panel-body">
				<form onsubmit="return false;"  class="form-inline form-label-auto" id="addRoleForm" action="${ctx}/system/role/addRole" method="post">
				 <div class="box-body">
...
<script type="text/javascript" src="${ctx}/static/pagejs/system/role/role-add.js${timeStyle}"></script>