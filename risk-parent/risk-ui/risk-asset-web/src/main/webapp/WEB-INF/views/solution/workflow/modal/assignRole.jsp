		...
		<div class="modal-body">
			<div class="panel-body">
              ...
              <table class="table  table-striped table-hover table-responsive" id="workflow_assign_table" data-toggle="table"
				data-url="${ctx}/solution/workflow/queryNodeAssignList"
...
<div class="modal" id="addAssignModal" tabindex="-1" role="dialog" aria-expanded="true">
	...
	<div class="modal-content">
		...
		<div class="modal-body">
			<div class="panel-body">
				<form onsubmit="return false;"  class="form-inline form-label-auto" id="addAssignForm" action="${ctx}/solution/workflow/addNodeAssign" method="post">
 ...
 <script type="text/javascript" src="${ctx}/static/pagejs/solution/workflow/workflow-assign-role.js"></script>