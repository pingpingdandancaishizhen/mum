...
<div class="tab-pane content-padding" id="allList">
        ...
        <form onsubmit="return false;" class="form-inline form-label-auto" role="form">
            <div class="form-group col-md-3 row-left">
                <div class="input-group">
                    ...
                    <select class="form-control" name="productType" id="productType_all">
            ...
            <div class="form-group col-md-3 row-left">
                <div class="input-group">
                    ...
                    <select class="form-control" name="currentTaskKey" id="currentTaskKey_all">
                        <option value="">请选择</option>
    ...
    <table class="table  table-striped table-hover" id="all_audit_table" data-toggle="table" style="width:2500px"
           data-url="${ctx}/loanaudit/queryAllAuditManager"
