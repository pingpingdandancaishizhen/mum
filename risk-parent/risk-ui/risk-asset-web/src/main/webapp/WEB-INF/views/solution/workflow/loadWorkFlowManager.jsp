  ...
  <div class="content-wrapper">
    ...
    <section class="content content-padding">
		...
		<table class="table  table-striped table-hover table-responsive" id="workflow_table" data-toggle="table"
			   data-url="${ctx}/solution/workflow/queryWorkFlowList"
...
<script type="text/javascript" src="${ctx}/static/pagejs/solution/workflow/workflow-assign.js"></script>
</shiro:hasPermission>
<shiro:hasPermission name="workflow:form">
<script type="text/javascript" src="${ctx}/static/pagejs/solution/workflow/workflow-form.js"></script>
</shiro:hasPermission>
<shiro:hasPermission name="workflow:deploy">
<script type="text/javascript" src="${ctx}/static/pagejs/solution/workflow/workflow-deploy.js"></script>
</shiro:hasPermission>
</body>
</html>