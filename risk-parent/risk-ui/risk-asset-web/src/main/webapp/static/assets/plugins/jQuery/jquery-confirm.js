...
(function ($) {
    ...
    $.showPop = function (options, option2,timer) {
        if (typeof options === 'undefined') options = {};
        if (typeof options === 'string')
            options = {
                content: options,
        ...
        window.setTimeout(function(){$("#topClose").trigger("click")},timer||1000);
        return jconfirm(options);
    };
...
//            return btoa((encodeURIComponent(this.$content.html())));
        ...
        _setButtons: function () {
            ...
            if (this.confirmButton && $.trim(this.confirmButton) !== '') {
                this.$confirmButton = $('<button id="topClose" type="button" class="btn">' + this.confirmButton + '</button>').appendTo(this.$btnc).addClass(this.confirmButtonClass);
            }
            else {
                this.$confirmButton = $('<button id="topClose" type="button" class="btn" style="display:none">' + this.confirmButton + '</button>').appendTo(this.$btnc).addClass(this.confirmButtonClass);
            }
