 ...
 */
@Controller
@RequestMapping("/solution/workflow")
public class WorkFlowController extends BaseController {
    ...
    public String loadWorkFlowManager(ModelMap map) {
        List<Product> list = productService.queryProductByCorpId(getCurrentUser().getCorpId());
        map.put("productList", list);
        return "/solution/workflow/loadWorkFlowManager";
    }
