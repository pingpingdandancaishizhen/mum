...
public class BPMetaUtils {
    ...
    public List<CheckRuleInfo> parseCheckRuleAsList(String checkRuleStr) {
        List<CheckRuleInfo> ruleList = new ArrayList<CheckRuleInfo>();
        return JsonUtils.parseJSON(checkRuleStr, ruleList.getClass());
    }

    public BPMetaNode findNode(BPMetaDTO bpMetaDTO, String nodeKey) {
    ...
    public BPMetaForm findForm(BPMetaDTO bpMetaDTO, String formKey) {
