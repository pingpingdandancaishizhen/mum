...
import cn.sunfit.risk.buz.api.constants.SystemNoticeType;
...
public class NoticeController extends BaseController {
    ...
    public String loadNoticeManager(HttpServletRequest request) {
        request.setAttribute("types", SystemNoticeType.values());
    ...
    public Resp queryCorpNotice(ArticleQueryReq req, String typeId) {
        ...
        String[] typeParam;
        if (typeId != null && SystemNoticeType.getNameByStatus(typeId) != null) {
            typeParam = new String[] { SystemNoticeType.getNameByStatus(typeId).getTypeId() };
        } else {
            typeParam = new String[] { SystemNoticeType.INTERNAL_NOTICE.getTypeId(),
                    SystemNoticeType.COM_RULE.getTypeId(), SystemNoticeType.HOLIDAY_NOTICE.getTypeId() };
        }
