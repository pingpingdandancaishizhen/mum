...
public class FraudApiResponse implements Serializable {
    ...
    private Map<String, String> geoip_info = new HashMap<String, String>(); // 地理位置信息
    private Map<String, Object> device_info = new HashMap<String, Object>(); // 设备指纹信息
    private Map<String, Object> attribution = new HashMap<String, Object>(); // 归属地信息
    private List<Policy> policy_set = new ArrayList<Policy>(); // 策略集信息
    private List<Map<String, Object>> output_fields = new ArrayList<Map<String, Object>>(); // 决策结果自定义输出
    ...
    public String toString() {
        return "FraudApiResponse [success=" + success + ", reason_code=" + reason_code + ", final_score=" + final_score
                + ", final_decision=" + final_decision + ", policy_name=" + policy_name + ", hit_rules=" + hit_rules
                + ", seq_id=" + seq_id + ", spend_time=" + spend_time + ", geoip_info=" + geoip_info + ", device_info="
                + device_info + ", attribution=" + attribution + ", policy_set=" + policy_set + ", output_fields="
                + output_fields + ", policy_set_name=" + policy_set_name + ", risk_type=" + risk_type + "]";
    }
