	            ...
	            <div class="tab-content">
	            	<div class="tab-pane active" id="operLog">
	            		<div class="panel-body">
							<div class="search-box" id="searchLogbar">


								<form onsubmit="return false;"  class="form-inline form-label-auto" role="form">
									<div class="form-group col-sm-5 row-left">
										<div class="input-group">
											<label class="label-head text-right">内容</label>
											<input type="text" class="form-control" name="content"  placeholder="输入内容">
										</div>
							...
							data-url="${ctx}/order/queryOperLog"
	              	...
	              	<div class="tab-pane" id="reviewLog">
	              		<div class="panel-body">
							...
							data-url="${ctx}/order/queryOperReviewLog"
							data-method="post" data-cache="false"  data-content-type="application/x-www-form-urlencoded"
...
<script type="text/javascript" src="${ctx}/static/pagejs/system/order/oper-log.js${timeStyle}"></script>