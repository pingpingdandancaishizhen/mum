...
<%@ include file="/WEB-INF/import/loading.jsp"%>
    ...
    <section class="content content-padding" >
		...
		<div class="table-top-tool">
			<shiro:hasPermission name="cust:add">
				<div class="btn btn-primary btn-primary-lg" id="add_customer_btn">
		...
		<table class="table  table-striped table-hover" id="customer_table" data-toggle="table"
			   data-url="${ctx}/system/customer/queryCustomer"
		...
		<div id="toolbar">
			<div>
				<shiro:hasPermission name="cust:loan">
					<div class="btn btn-white" id="apply_loan_btn">
						<!--<i class="icon icon-plus"></i>-->
						<span>借款登记</span>
					</div>
				</shiro:hasPermission>
				<shiro:hasPermission name="cust:delete">
					<div class="btn btn-white" id="delete_customer_btn">
						<!--<i class="fa fa-trash-o"></i>-->
						<span>删除</span>
					</div>
				</shiro:hasPermission>
				<shiro:hasPermission name="cust:modify">
					<div class="btn btn-white" id="modify_customer_btn">
				...
				<shiro:hasPermission name="cust:log">
  ...
  <%@include file="./modal/selectProductModal.jsp" %>
	<script type="text/javascript" src="${ctx}/static/pagejs/system/customer/customer.js"></script>
