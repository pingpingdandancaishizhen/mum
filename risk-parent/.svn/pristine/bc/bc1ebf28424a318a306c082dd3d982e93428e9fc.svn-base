...
<%@ include file="/WEB-INF/import/loading.jsp"%>
		...
		<div id="toolbar">
			<div class="btn-group">
				<shiro:hasPermission name="notice:delete">
					<input type="button" class="btn btn-white" id="delete_notice_btn" value="删除"/>
				</shiro:hasPermission>
				<shiro:hasPermission name="notice:modify">
					<input type="button"  class="btn btn-white" id="edit_notice_btn" value="修改"/>
				</shiro:hasPermission>
				<shiro:hasPermission name="notice:disable">
					<input type="button"  class="btn btn-white" id="disable_notice_btn" value="下架"/>
				</shiro:hasPermission>
				<shiro:hasPermission name="notice:enable">
					<input type="button"  class="btn btn-white" id="enable_notice_btn" value="发布"/>
				</shiro:hasPermission>
			</div>
 ...
 <script type="text/javascript" src="${ctx}/static/pagejs/system/notice/notice.js${timeStyle}"></script>
 <shiro:hasPermission name="notice:add">
  	<script type="text/javascript" src="${ctx}/static/pagejs/system/notice/notice-add.js${timeStyle}"></script>
  </shiro:hasPermission>
  <shiro:hasPermission name="notice:enable">
  	<script type="text/javascript" src="${ctx}/static/pagejs/system/notice/notice-enable.js${timeStyle}"></script>
  </shiro:hasPermission>
  <shiro:hasPermission name="notice:disable">
  	<script type="text/javascript" src="${ctx}/static/pagejs/system/notice/notice-disable.js${timeStyle}"></script>
  </shiro:hasPermission>
  <shiro:hasPermission name="notice:delete">
  	<script type="text/javascript" src="${ctx}/static/pagejs/system/notice/notice-delete.js${timeStyle}"></script>
  </shiro:hasPermission>
  <shiro:hasPermission name="notice:modify">
