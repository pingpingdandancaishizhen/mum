					...
					<div class="panel-body">
						...
						<div class="col-sm-6 row-right">
							<div class="form-group input-group" >
								...
								<div class="label-box label-box-sm">
									<input readonly type="text" maxlength="18" class="form-control" id="licenseNum" name="licenseNum" value="${customer.licenseNum}">
								</div>
						...
						<div class="col-sm-6 row-right">
							<div class="form-group input-group ">
								...
								<div class="label-box label-box-sm">
									<input readonly type="text" maxlength="20" class="form-control" id="houseSpending" name="houseSpending" value="${customer.houseSpending}">
								</div>
						...
						<div class="col-sm-6 row-right">
							<div class="form-group input-group">
								...
								<div class="label-box label-box-sm">
									<input readonly type="text" maxlength="11" class="form-control" id="mobile" name="mobile" value="${customer.mobile}">
								</div>
						...
						<div class="col-sm-6 row-right">
							<div class="form-group input-group">
								...
								<div class="label-box label-box-sm">
									<input readonly type="text" maxlength="11" class="form-control" id="mobile2" name="mobile2" value="${customer.mobile2}">
								</div>
					...
					<div class="panel-body">
						<div class="col-sm-6 row-right">
							<div class="form-group input-group">
								...
								<div class="label-box label-box-sm">
									<input readonly type="text"  class="form-control"  name="industry" value="${customer.industry}"  readonly="readonly" data-industry-job="${customer.industry},${customer.job}">
								</div>
						...
						<div class="col-sm-6 row-right">
							<div class="form-group input-group">
								...
								<div class="label-box label-box-sm">
									<input readonly type="text"  class="form-control" id="job" name="job" value="${customer.job}" readonly="readonly">
								</div>
						...
						<div class="col-sm-6 row-right">
							<div class="form-group input-group">
								...
								<div class="label-box label-box-sm">
									<select disabled="disabled"  class="form-control" name="companyType" id="companyType">
										<option value="">请选择</option>
						...
						<div class="col-sm-6 row-right">
							<div class="form-group input-group">
								...
								<div class="label-box label-box-sm">
									<input readonly type="text" maxlength="20" class="form-control" id="companyName" name="companyName"  value="${customer.companyName}" >
								</div>
						...
						<div class="col-sm-6 row-right">
							<div class="form-group input-group">
								...
								<div class="label-box label-box-sm">
									<input readonly type="text" maxlength="15" class="form-control" id="deptName" name="deptName" value="${customer.deptName}">
								</div>
						...
						<div class="col-sm-6 row-right">
							<div class="form-group input-group">
								...
								<div class="label-box label-box-sm">
									<input readonly type="text"  class="form-control"  name="entryTime" value="<fmt:formatDate value="${customer.entryTime}" pattern="yyyy-MM-dd"/>" readonly="readonly">
								</div>
						...
						<div class="col-sm-6 row-right">
							<div class="form-group input-group">
								...
								<div class="label-box label-box-sm">
									<input readonly type="text" maxlength="20" class="form-control" id="salary" name="salary" value="${customer.salary}">
								</div>
						...
						<div class="col-sm-6 row-right">
							<div class="form-group input-group">
								...
								<div class="label-box label-box-sm">
									<input readonly type="text" maxlength="20" class="form-control" id="salaryDate" name="salaryDate" value="${customer.salaryDate}">
								</div>
						...
						<div class="col-sm-6 row-right">
							<div class="form-group input-group">
								...
								<div class="label-box label-box-sm">
									<select disabled="disabled"  class="form-control" name="salaryType" id="salaryType">
										<option value="">请选择</option>
						...
						<div class="col-sm-6 row-right">
							<div class="form-group input-group">
								...
								<div class="label-box label-box-sm">
									<input readonly type="text" maxlength="13" class="form-control" id="companyPhone" name="companyPhone" value="${customer.companyPhone}">
								</div>
						...
						<div class="col-sm-6 row-right">
							<div class="form-group input-group">
								...
								<div class="label-box label-box-sm">
									<input readonly type="text" class="form-control " id="" name="companyAddr" value="${customer.companyAddr}" readonly="readonly">
								</div>
								<div class="label-box label-box-sm">
									<input readonly type="text"  class="form-control " id="companyAddrDetail" name="companyAddrDetail" value="${customer.companyAddrDetail}" placeholder="请输入详细地址">
								</div>
							</div>
						</div>
					</div>
