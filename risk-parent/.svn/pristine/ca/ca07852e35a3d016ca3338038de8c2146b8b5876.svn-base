            ...
            <form  onsubmit="return false;" class="form-label-auto "
                  action="${ctx}/asset/saveAsset" method="post">
                        ...
                        <div class="col-md-12 pages-form">
                          <input type="hidden" name="acceptAccountBank"/>
					    <input type="hidden" name="repaymentBank"/>
					    <input type="hidden" name="acceptAccountBankVal"/>
					    <input type="hidden" name="repaymentBankVal"/>
                         <div class="sub-head">
                    资产方基本信息
                </div>
                        ...
                        <div class="col-sm-12 row-right">
                          ...
                          <div class="col-sm-6 row-right ">
                            <div class="form-group input-group">
                                ...
                                <div class="label-box label-box-sm">
                                    <input type="text"  class="form-control" id="acceptAccountNum" name="acceptAccountNum">
                                </div>
                           ...
                           <div class="col-sm-6 row-right ">
                            ...
                            <div class="form-group input-group">
                                ...
                                <div class="label-box label-box-sm">
                                    <input type="text" maxlength="20" class="form-control" id="repaymentName" name="repaymentName">
                                </div>
                          ...
                          <div class="col-sm-6 row-right ">
                            <div class="form-group input-group">
                                ...
                                <div class="label-box label-box-sm">
                                    <input type="text"  class="form-control" id="repaymentNum" name="repaymentNum">
                                </div>
                           ...
                           <div class="col-sm-6 row-right ">
                            <div class="form-group input-group">
                                ...
                                <div class="label-box label-box-sm">
                                    <input type="text" maxlength="20" class="form-control" id="repaymentBranchBank" name="repaymentBranchBank">
                                </div>
