...
public interface SolutionService {
    ...
    List<BpMetaCorpProductVO> queryAllBPMetaCorpProduct(BpMetaQueryReq req);

    List<BpMetaNodeVO> queryAllNodeListTask(BpMetaNodeQueryReq req);
    ...
    List<BpMetaCorpProductVO> queryDeptMeteCorpProduct(String domain, String deptId);

    List<BpMetaNodeVO> queryDeptNodeListTask(String domain, String bpDefId, String deptId);
