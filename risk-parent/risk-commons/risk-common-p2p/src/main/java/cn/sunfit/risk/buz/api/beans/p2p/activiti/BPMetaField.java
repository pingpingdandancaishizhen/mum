 ...
 * BP属性字段元数据
 * @Title: BPMetaField.java
 * @Description: BP属性字段元数据
 * @author zouxuejun
 * @date 2017年1月6日 上午11:13:42
 * @version V1.0
 */
public class BPMetaField extends BaseObject {
    ...
    public void setFieldTable(String fieldTable) {
        this.fieldTable = fieldTable == null ? null : fieldTable.trim();
    }
