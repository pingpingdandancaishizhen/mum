...
public class DateUtil {
     ...
     * @return 时间差
     */
    public static int countDateString(String oldDate, String currentDate) {
     ...
     * @return
     */
    public static List<Date> getDateBetweenDays(Date startDate, Date endDate) {
    ...
    public static List<String> getDatesLastDay(Date startDate, Date endDate) {
        ...
        if (getDateString(startDate).equals(getDateString(endDate))) {
            list.add(getDateString(getDate(getYear(startDate), getMonth(startDate),
                    getDaysCount(getYear(startDate), getMonth(startDate)))));
            return list;
        }
        Date d = startDate;
        String date = null;
    ...
    public static void main(String[] args) throws ParseException {
        ...
        calendar.setTime(date);
        calendar.set(Calendar.DAY_OF_MONTH, calendar.get(Calendar.DAY_OF_MONTH) + 1);// 让日期加位移量
     ...
     * @return
     */
    public static Date sToDate(String dateS) {
        SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd");
        if (dateS.indexOf("-") == -1) {
    ...
    public static Date toDate(String dateS, String formatStr) {
        SimpleDateFormat format = new SimpleDateFormat(formatStr);
        Date date = null;
        try {
            date = format.parse(dateS);
